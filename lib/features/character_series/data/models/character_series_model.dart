...
class CharacterSeriesModel extends CharacterSeries {
  ...
  factory CharacterSeriesModel.fromJson(Map<String, dynamic> json) => CharacterSeriesModel(
        code: json["code"],
        status: json["status"],
  ...
  CharacterSeries toEntity() => CharacterSeries(
        code: code,
        status: status,
        copyright: copyright,
        attributionText: attributionText,
